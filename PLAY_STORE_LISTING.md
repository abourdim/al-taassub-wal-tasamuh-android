# Play Store listing — Al Taassub wal Tasamuh (التعصب والتسامح)
...
- **Package name**: `org.workshopdiy.altaassubwaltasamuh`
...
```
كتاب "التعصب والتسامح" تطبيق تفاعلي — للشيخ محمد الغزالي
```

### Full description (≤4000 chars)
```
🕊 التعصب والتسامح — تطبيق تفاعلي

تطبيق تفاعلي ثلاثي اللغة (عربي/إنجليزي/فرنسي) مستوحى من كتاب "التعصب والتسامح" للشيخ محمد الغزالي رحمه الله (1917–1996).
...
• كتاب "التعصب والتسامح" — الشيخ محمد الغزالي
...
### App name
```
Al Taassub wal Tasamuh — Fanaticism & Tolerance
```

### Short description
```
"Fanaticism & Tolerance" — interactive trilingual app by Sheikh al-Ghazali
```
...
Interactive trilingual app (Arabic / English / French) based on the book "Fanaticism & Tolerance" by Sheikh Mohammed al-Ghazali (1917–1996).
...
• "Fanaticism & Tolerance" — Sheikh Mohammed al-Ghazali
...
### App name
```
Al Taassub wal Tasamuh — Al Taassub wal Tasamuh
```

### Short description
```
« Fanaticism & Tolerance » — application trilingue par Cheikh al-Ghazali
```
...
Application interactive trilingue (arabe / anglais / français) inspirée du livre « Fanaticism & Tolerance » du Cheikh Mohammed al-Ghazali (1917–1996).
...
• « Fanaticism & Tolerance » — Cheikh Mohammed al-Ghazali
...
```
Privacy Policy — Al Taassub wal Tasamuh
Last updated: 2026-04-26

The Al Taassub wal Tasamuh app does not collect, store, transmit, or share any personal
